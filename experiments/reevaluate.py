...
def reevaluate(agent, input_csv_file, output_path, tolerance, suffix = ""):
    new_df_path = os.path.join()
    ...
    for index, row in df.iterrows():
        ...
        if agent_move != ' ':
            ...
            generate_problem_file_state('pddls/LegoProblem2d.pddl', (agent_applied_state, end))
...
reevaluate('results\claude-3-7-sonnet-20250219\claude-3-7-sonnet-20250219_results.csv', 'e')
