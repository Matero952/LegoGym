def generate_prompt(start_state, end_state):
    prompt = f'''
This is a block-stacking task. Youre given two 2D arrays: a start and a goal configuration. Each array is 5×5, where 1 is a block and 0 is an empty cell. A block is located at its (row, column) index.
